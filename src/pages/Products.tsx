...
import { BookmarkPlus, Check, Grid2X2, List, Search, Share2, SlidersHorizontal, X } from 'lucide-react'
...
export default function Products() {
  ...
  return (
    <Layout wide>
      ...
      <div className="-mx-1 mt-2 overflow-hidden rounded-2xl border border-outline/80 bg-surface p-2 shadow-[0_6px_16px_rgba(15,23,42,0.035)] sm:mx-0 sm:mt-0 sm:overflow-visible sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none"><CategoryPills categories={categories} selectedId={categoryId} onSelect={handleCategorySelect} /></div>

      <div className="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-outline bg-surface px-3.5 py-2.5 text-sm text-ink-700 shadow-[0_5px_14px_rgba(15,23,42,0.03)] sm:px-4">
