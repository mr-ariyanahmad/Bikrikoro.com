  ...
  return <Layout wide>
    ...
    <div className="mx-auto max-w-5xl">
      <header className="border-b border-outline pb-5">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-ink-600">বাংলাদেশি buyer ও seller-দের জন্য practical marketplace শিক্ষা, নিরাপত্তা, listing tips এবং BikriKoro-এর Bikrify authentication brand-এর বিশ্লেষণ।</p>
      </header>
