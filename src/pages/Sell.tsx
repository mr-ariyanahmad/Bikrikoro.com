    ...
    <Layout wide>
      ...
      <div className="mt-6 space-y-5">
        ...
        <section className="border border-outline bg-surface p-4">
          ...
          <div className="mt-3 flex items-center justify-between gap-3 border border-brand-200 bg-brand-50 px-3 py-2.5 text-xs"><span className="text-ink-600">ক্রেতারা product card ও detail page-এ এই স্থায়ী সুবিধা দেখবেন</span><span className={`shrink-0 px-2 py-1 font-semibold ${autoDeliveryEnabled ? 'bg-brand-500 text-white' : 'bg-amber-100 text-amber-900'}`}>{autoDeliveryEnabled ? 'অটো ডেলিভারি' : 'ম্যানুয়াল ডেলিভারি'}</span></div>
