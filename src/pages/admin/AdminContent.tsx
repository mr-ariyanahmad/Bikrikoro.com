...
type Post = { id: string; title: string; slug: string; excerpt: string; body: string; status: string; created_at: string; content_type?: string; cover_image_url?: string | null; seo_title?: string | null; seo_description?: string | null }
type PostForm = { title: string; slug: string; excerpt: string; body: string; cover_image_url: string; seo_title: string; seo_description: string }

const EMPTY_POST: PostForm = { title: '', slug: '', excerpt: '', body: '', cover_image_url: '', seo_title: '', seo_description: '' }
...
export default function AdminContent({ mode }: { mode: Mode }) {
  ...
  const startEdit = (post: Post) => {
    ...
    setPostForm({ title: post.title, slug: post.slug, excerpt: post.excerpt, body: post.body, cover_image_url: post.cover_image_url ?? '', seo_title: post.seo_title ?? '', seo_description: post.seo_description ?? '' })
    setShowForm(true)
  }
