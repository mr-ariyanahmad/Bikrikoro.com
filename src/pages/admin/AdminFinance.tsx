...
const PAYMENT_METHODS: Record<string, { label: string; logo: string; color: string }> = { BKASH: { label: 'bKash', logo: '/payment-logos/bkash.png', color: '#a80d51' }, NAGAD: { label: 'Nagad', logo: '/payment-logos/nagad.png', color: '#b43b14' }, ROCKET: { label: 'Rocket', logo: '/payment-logos/rocket.png', color: '#5e2165' }, UPAY: { label: 'Upay', logo: '/payment-logos/upay.png', color: '#17719d' } }
            ...
            {rows.map((row) => {
              ...
              return (
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      <p className="flex items-center gap-2 font-semibold text-slate-800"><PaymentMethodBadge method={row.method} /><span>{formatTaka(row.amount)}</span></p>
