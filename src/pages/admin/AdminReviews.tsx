...
export default function AdminReviews() {
  ...
  const visible = useMemo(() => {
    ...
    return reviews.filter((review) => (!rating || String(review.rating) === rating) && (!value || `${review.product_title} ${review.buyer_name} ${review.comment}`.toLowerCase().includes(value)))
