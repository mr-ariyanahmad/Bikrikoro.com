...
export default function AdminDeliveries() {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    const [physicalResult, digitalResult] = await Promise.all([
