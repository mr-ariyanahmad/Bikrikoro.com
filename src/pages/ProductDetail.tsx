...
export default function ProductDetail() {
  ...
  return (
    <Layout wide hideFooter={showBuy} hideMobileQuickNav hideMobileHeader mobileBottomBar>
      <Helmet>
