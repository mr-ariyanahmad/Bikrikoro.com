...
export default function Home() {
  ...
  return <Layout wide>
    <Helmet><title>BikriKoro.Com — বাংলাদেশের নিরাপদ ডিজিটাল মার্কেটপ্লেস</title><meta name="description" content="এসক্রো-সুরক্ষিত ডিজিটাল মার্কেটপ্লেস — নিরাপদে digital key, file, access, course ও service কিনুন এবং বিক্রি করুন।" /></Helmet>
    ...
    <section className="mb-5 grid gap-3 sm:grid-cols-3">
      ...
      <Link to="/products" className="rounded-2xl border border-brand-100 bg-brand-50 p-4 transition hover:border-brand-500"><div className="flex items-center justify-between"><span className="text-sm text-brand-700">Digital protection</span><ShieldCheck size={19} className="text-brand-600" /></div><p className="mt-2 text-lg font-bold text-brand-800">Escrow ও delivery</p><p className="mt-1 text-xs text-brand-700/70">নিরাপদ digital product দেখুন →</p></Link>
    </section>

    <section className="mb-6 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 p-6 text-white sm:p-8"><p className="text-sm font-medium text-brand-50/80">নিরাপদ ডিজিটাল মার্কেটপ্লেস</p><h1 className="mt-1 text-2xl font-semibold sm:text-3xl">বিশ্বাস করে কিনুন, নিশ্চিন্তে বিক্রি করুন</h1><p className="mt-2 max-w-md text-sm text-brand-50/90">এসক্রো সুরক্ষায় প্রতিটা লেনদেন — digital delivery পেয়ে আপনি confirm করার পরেই seller wallet-এ payout যায়।</p><Link to="/sell" className="mt-4 inline-block rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-brand-700 transition hover:bg-brand-50">পণ্য বিক্রি করুন</Link></section>
