...
const PLATFORM_META = {
  ...
  FACEBOOK: { label: 'Facebook community', action: 'Facebook-এ যোগ দিন', gradient: 'from-[#1877f2] to-[#0b4da2]', iconClass: 'bg-white/15 text-white' },
  TELEGRAM: { label: 'Telegram channel', action: 'Telegram-এ যোগ দিন', gradient: 'from-[#168dcc] to-[#075985]', iconClass: 'bg-white/15 text-white' },
