...
const ALLOWED_ADMIN_RPCS = new Set([
  ...
  'admin_upsert_payment_account',
  'admin_delete_payment_account',
  'admin_send_notification',
  'admin_send_support_case_message',
  'admin_update_support_case_status',
  'admin_send_seller_notification',
  ...
  'admin_delete_community_link',
  'admin_upsert_banner',
  'admin_upsert_category',
  'admin_upsert_community_link',
