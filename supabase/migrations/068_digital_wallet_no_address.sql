-- BikriKoro: digital wallet checkout does not require a physical delivery address.
-- The product must remain approved, visible, digital, and different from the buyer.
...
begin
  ...
  insert into public.orders (
    ...
    null, 'WALLET', 'ESCROW_HELD', v_escrow_fee
